...
<head>
    ...
    <title>Manage Donors - Organ Donation System</title>
...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="/admin/donors"><i class="fas fa-hand-holding-heart"></i> Donors</a>
    ...
    <div class="main-content">
        ...
        <div class="table-container">
            <table class="table table-hover">
                <thead><tr><th>ID</th><th>Name</th><th>Email</th><th>Blood Group</th><th>Organs</th><th>Status</th></tr></thead>
                <tbody>
                    <c:forEach items="${donors}" var="donor">
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${donor.kycStatus == 'VERIFIED'}"><span class="badge bg-success">Verified</span></c:when>
